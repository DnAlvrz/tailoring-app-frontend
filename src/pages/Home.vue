            ...
            <div class="flex justify-center items-center mt-10">
                <nav aria-label="Page navigation example">
                  <ul class="flex items-center -space-x-px h-8 text-sm">
                    ...
                    <li>
                      <a href="#" aria-current="page" class="z-10 flex items-center justify-center px-3 h-8 leading-tight text-primary-0 border  border-tertiary-0 bg-tertiary-0 hover:bg-blue-100 hover:text-tertiary-0">1</a>
                    </li>
                    <li>
