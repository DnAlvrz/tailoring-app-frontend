            ...
            <div class="rounded-lg md:w-2/3">
                <div class="md:w-full w-screen mb-4">
                    <div class="p-4 bg-primary-0 w-full">
                        ...
                        <div v-if="userData" class="flex flex-col lg:flex-row lg:gap-60">
                            <div class="lg:ml-5">
                                <p class="font-roboto font-semibold text-secondary-0">{{ userData.first_name + ' ' + userData.last_name}}</p>
                                <p class="font-roboto font-semibold text-secondary-0">{{ userData.phone }}</p>
                            </div>
                            <div class="mr-5">
                                <p class="font-roboto font-semibold md:text-xl text-secondary-0">{{ userData.address }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-else class="text-center h-50 bg-primary-0 mt-2 p-4">
...
const getUser = async () => {
    try {
        ...
        if (user) {
            ...
            const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/user`, config);
