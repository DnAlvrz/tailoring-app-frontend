    ...
    <div class="flex w-full shadow border rounded-3xl">
        ...
        <div class="w-full px-5 md:w-1/2 py-6 md:px-10">
            ...
            <form>
                ...
                <button type="submit" class="text-white bg-tertiary-0 hover:bg-secondary-0 font-medium rounded-lg text-sm w-full sm:w-full px-5 py-2.5 text-center">LOGIN</button>
            </form>
        </div>
    </div>
</template>