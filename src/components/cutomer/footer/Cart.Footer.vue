<template>
    <div class="bg-primary-0 fixed bottom-0 right-0 left-0 shadow mt-auto">
        <div class="w-full flex flex-row justify-between items-center">
            <div class="flex gap-2 items-center p-4 ml-4">
                ...
                <p class="text-sm text-secondary-0 p-2 font-roboto">Total<span class="text-lg font-roboto text-secondary-0 font-semibold p-1">₱<span>449</span></span></p>
