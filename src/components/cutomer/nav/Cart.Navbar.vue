<template>
    <nav class="bg-primary-0 max-w-full shadow border z-10 fixed top-0 left-0 right-0 md:hidden block">
        <div class="p-4">
            <button class="mr-2">
                <font-awesome-icon icon="fa-solid fa-arrow-left" style="color: #ACA7CB;" />
            </button>
            <span class="font-roboto text-secondary-0">Shopping Cart</span>
        </div>
    </nav>
            ...
            <div class="p-4">
                    ...
                    <div id="dropdown" class="z-10 w-full hidden bg-white shadow">
                        <form>   
                            ...
                            <div class="relative">
                                ...
                                <input type="search" id="default-search" class="block  max-lg:w-full p-4 ps-10 font-roboto text-sm text-secondary-0 border border-gray-300 bg-gray-50 focus:ring-tertiary-0 focus:border-tertiary-0" placeholder="Search Shopping Cart" required>
                            </div>
                        </form>
                    </div>
                </div>
                <form class="hidden md:block">   
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" class="block w-[500px] max-lg:w-full p-4 ps-10 font-roboto text-sm text-secondary-0 border border-gray-300 rounded-lg bg-gray-50 focus:ring-tertiary-0 focus:border-tertiary-0" placeholder="Search Shopping Cart" required>
                    </div>
                </form>
            </div>
