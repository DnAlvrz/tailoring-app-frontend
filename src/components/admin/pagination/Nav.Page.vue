    ...
    <div class="flex justify-center items-center mt-10">
        <nav aria-label="Page navigation example">
            <ul class="inline-flex -space-x-px text-sm">
                ...
                <li>
                    <a href="#" aria-current="page" class="flex items-center justify-center px-3 h-8 text-primary-0 border border-gray-300 bg-tertiary-0 hover:bg-secondary-0 hover:text-primary-0">3</a>
                </li>
                <li>
